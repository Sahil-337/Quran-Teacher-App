...
const Welcome = () => {
  ...
  const clearLogin = () => {
    AsyncStorage.removeItem('QuranTeacherAppCredentials')
      .then(() => {
  ...
  return (
    <>
      ...
      <InnerContainer>
        ...
        <WelcomeContainer>
          <PageTitle welcome={true}>Welcome! Ustad</PageTitle>
          <SubTitle welcome={true}>{name || 'Full Name'}</SubTitle>
          <SubTitle welcome={true}>{email || 'Email Address'}</SubTitle>
